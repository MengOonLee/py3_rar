...
call pip install --no-cache-dir -U ^
 ...
 matplotlib seaborn dash scikit-learn xgboost statsmodels prophet networkx ^
 apache-beam tf-keras tensorflow-cpu tensorflow-probability tfcausalimpact ^
 torch torchvision torchaudio torch_geometric ortools pyod
call pip check
call deactivate
